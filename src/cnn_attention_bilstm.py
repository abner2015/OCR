...
class CNNAttentionBiLSTM(gluon.HybridBlock):
    '''
    recognise the image
    ...
    def __init__(self,num_downsamples=2,resnet_layer_id = 4,rnn_hidden_states=200,rnn_layers=1,max_seq_len=100,ctx=mx.gpu(0),**kwargs):
        super(CNNAttentionBiLSTM,self).__init__(**kwargs)
        self.p_dropout = 0.5
        self.num_downsamples = num_downsamples
        self.max_seq_len = max_seq_len
        self.ctx = ctx
        self.alignment_dim = 1024
    ...
    def get_body(self,resnet_layer_id):
        ...
        body = gluon.nn.HybridSequential(prefix="_body")
